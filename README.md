...
- при первом включении result-tracking засевает уже завершённые позиции в state без массовой исторической рассылки;
...
- Result-уведомления при первом включении не делают backfill всего исторического архива; дальше бот шлёт только новые результаты.
